    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.RemoveLoginSuccess ? "Usunięto możliwość logowania się dadatkową metodą"
                : "";
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Obecne hasło jest nieprawidłowe lub nowe hasło jest niepoprawne.");
                    }
                }
            }
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", String.Format("Nie udało się utworzyć konta.Konto z taką nazwą\"{0}\" już istnieje.", User.Identity.Name));
                    }
                }
            }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (EntitiesNieruchomosci db = new EntitiesNieruchomosci()) 
                {
                    ...
                    {
                        ModelState.AddModelError("UserName", "Użytkownik już istnieje. Wpisz inną nazwę");
                    }
                }
            }
